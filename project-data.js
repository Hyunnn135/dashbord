window.PROJECT_DATA = {
  ...
  "tasks": [
    ...
    },
    {
      "id": "n10g",
      "project": "nudge",
      "title": "[Phase 3/수정] Complication NudgeSync 3-copy 정합화 마무리 — 04-17 커밋이 'complication copy has no handleRemote' 오판으로 누락한 컴플리케이션 타깃까지 동일 구조로 맞춤 (import WidgetKit 가드 해제 / #if os(iOS) 가드 제거 / didReceiveUserInfo 추가 / Comp: 접두사 로그 보강)",
      "status": "done",
      "priority": "mid",
      "phase": "Phase 3: Watch 동기화",
      "tags": [
    ...
    },
    {
      "id": "n10h",
      "project": "nudge",
      "title": "[Phase 3/수정] Watch ContentView 에 WKApplication.didBecomeActiveNotification 훅 추가 — iOS 의 UIApplication.didBecomeActiveNotification 대칭. 포그라운드 복귀 시 refresh + pushLocalChange (컴플리케이션 탭 후 앱 복귀 경로에서 iPhone push 누락 가능성 제거)",
      "status": "done",
      "priority": "mid",
      "phase": "Phase 3: Watch 동기화",
      "tags": [
